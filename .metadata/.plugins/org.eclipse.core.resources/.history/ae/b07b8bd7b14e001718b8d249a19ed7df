...
public class Propriet‡Test {
	Propriet‡ p,p1,p2,p3,p4; Banca B; wrapper wrap;
	...
	public void costruisciCaseTest(){
		...
		assertEquals(p.getNumeroCase(),expectedHouse);
	}
	@Test
	public void costruisciAlbergo(){
		...
		assertEquals(p.getAlbergo(),albergo);
	}
	@Test
