...
public class GiocatoreTest {
	Giocatore g,g1; ArrayList<Proprietà> lp; Proprietà p;
	...
	public void setUp() throws Exception {
		...
		p = new Proprietà(1,"Via Tulipano",1,1,1,1);
	}
	@Parameters
	...
	@Test
	public void testAddProprietà(){
		//Proprietà p = new Proprietà(1,"Via Tulipano",1,1,1,1);
		g.addPropriety(p);
		assertEquals(1,g.getMyProperties().size());
	}
	@Test
	public void testRemoveProprietà(){
		g.removeProperty(p);
		assertEquals(0,g.getMyProperties().size());
	}
	@Test
	public void testPrintProprietàInLista(){
		g.addPropriety(p);
		String s = g.PrintProprietàinLista();
		assertNotNull(s);
	}
	@Test
